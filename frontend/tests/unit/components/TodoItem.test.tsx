...
describe("TodoItem - Good Examples", () => {
	...
	it("shows overdue style when todo is overdue", () => {
		...
		render(
			<TodoItem todo={overdueTodo} onToggle={vi.fn()} onDelete={vi.fn()} />,
		);
	...
	it("does not render description when empty", () => {
		...
		render(
			<TodoItem todo={noDescTodo} onToggle={vi.fn()} onDelete={vi.fn()} />,
		);
	...
	it("does not render due date when null", () => {
		...
		render(
			<TodoItem todo={noDueDateTodo} onToggle={vi.fn()} onDelete={vi.fn()} />,
		);
